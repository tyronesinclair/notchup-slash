  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">
        Add every bill you want lowered. We work them one at a time, all under one subscription.
      </p>
      ...
      <div className={`mt-6 rounded-xl border p-5 ${paydayMissing ? "border-red-300 bg-red-50/40" : "border-violet-200 bg-violet-50/40"}`}>
        ...
        <p className="text-xs text-gray-500 mb-3">You pay nothing today. Your first $15 comes out on your payday, then once a month after that. Cancel before your payday and you pay nothing at all.</p>
      ...
      <div className="flex gap-3 mt-3">
        ...
        >
          {isLoading ? (<><Loader2 size={16} className="animate-spin" /> Preparing…</>) : "Continue · $0 today →"}
        </button>
      </div>
    </div>
  );
