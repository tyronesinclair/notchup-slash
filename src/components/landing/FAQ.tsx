...
const items = [
  ...
  { q: "Which providers do you negotiate?", a: "Rogers, Bell, Telus, Freedom, Videotron, Shaw, Fido, Koodo, and most regional Canadian carriers. We support both internet and mobile lines." },
