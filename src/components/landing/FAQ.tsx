...
export const faqItems = [
  ...
  { q: "Why is it $0 today?", a: "Because a random charge in the middle of the month isn't how anyone's budget works. You tell us your next payday at sign-up; nothing is charged until then. Cancel before that date from your billing link and you pay nothing at all. After the first payment it's $15 on the same day each month." },
  ...
  { q: "How does the 30-day money-back guarantee work?", a: "Cancel before your first payday and you're never charged. After that, if Slash isn't for you, email help@notchup.app within 30 days of your first payment and we refund it — no questions, no forms, no phone call. After that, cancel anytime from the billing link in your confirmation email (or the Manage page on this site) and you won't be charged again." },
  ...
  { q: "Which bills can Slash negotiate?", a: "Right now: internet, mobile, TV/cable and home phone with most major Canadian carriers (Rogers, Bell, Telus, Shaw, Videotron, Freedom, Fido, Koodo, Virgin Plus, Cogeco, Eastlink and many regional providers). Home security and insurance are next. We can't negotiate regulated utilities like hydro, gas or water — and we'll tell you that plainly rather than pretend." },
  ...
  { q: "Do I have to do anything after signing up?", a: "One small thing: when Slash signs in, your provider texts a one-time security code to your phone, and we'll ask you to pass it along. After that, you just approve or reject the offers we bring you." },
